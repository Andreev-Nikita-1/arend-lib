...
public class CoherentFieldsProvider extends FieldsProvider{

    public CoherentFieldsProvider() {
    }

    @Dependency(module = "CategoryLanguage.Coherent", name = "CoherentPrecat")
    private CoreClassDefinition CoherentPrecat;
    ...
    @Dependency(module = "CategoryLanguage.Coherent", name = "IF")
    private CoreFunctionDefinition IF;
    @Dependency(module = "CategoryLanguage.Coherent", name = "IP")
    ...
    @Dependency(module = "CategoryLanguage.Coherent", name = "Formula")
    public CoreDataDefinition Formula;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Formula.Conj")
    private CoreConstructor Conj;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Formula.Eq")
    private CoreConstructor Eq;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Formula.FParam")
    private CoreConstructor FParam;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Formula.FTrue")
    private CoreConstructor FTrue;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Formula.FExists")
    private CoreConstructor FExists;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Formula.FFalse")
    private CoreConstructor FFalse;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Formula.Disj")
    ...
    public FieldsProvider.ExpressionAndPattern impl(FieldsProvider.ExpressionAndPattern a, FieldsProvider.ExpressionAndPattern b) {
        errorReporter.report(new TypecheckingError("Coherent theories doesn't support implications", marker));
        return null;
    }
    ...
    public FieldsProvider.ExpressionAndPattern forall(FieldsProvider.ExpressionAndPattern dom1, FieldsProvider.ExpressionAndPattern form) {
        errorReporter.report(new TypecheckingError("Coherent theories doesn't support 'Forall'", marker));
        return null;
    }

    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof")
    public CoreDataDefinition Proof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.idProof")
    private CoreConstructor idProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.transProof")
    private CoreConstructor transProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.substProof")
    private CoreConstructor substProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.reflProof")
    public CoreConstructor reflProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.transportProof")
    public CoreConstructor transportProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.concatProof")
    private CoreConstructor concatProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.pmapProof")
    private CoreConstructor pmapProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.invProof")
    private CoreConstructor invProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.proj1Proof")
    private CoreConstructor proj1Proof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.proj2Proof")
    private CoreConstructor proj2Proof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.tupleProof")
    private CoreConstructor tupleProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "Proof.trueProof")
    private CoreConstructor trueProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "proofParam")
    private CoreFunctionDefinition paramProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "recExistsProof")
    private CoreFunctionDefinition recExistsProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "existsConsProof")
    private CoreFunctionDefinition existsConsProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "recDisjProof")
    private CoreFunctionDefinition recDisjProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "inlProof")
    private CoreFunctionDefinition inlProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "inrProof")
    private CoreFunctionDefinition inrProof;
    @Dependency(module = "CategoryLanguage.Coherent", name = "absurdProof'")
